...
== Features ==  
✔ **Primary Meta Tags:** Auto-generates title, description, and canonical link  
✔ **Open Graph / Facebook Tags:** Supports og:title, og:description, og:image, and URL  
✔ **Twitter Card Tags:** Generates summary & large image card meta tags  
✔ **Schema Markup (JSON-LD):** Injects structured data for better SEO visibility  
✔ **Auto-Fetch Featured Image:** Uses post thumbnail dynamically  
✔ **Admin Settings Panel:** Set global defaults for Open Graph & Twitter metadata  
✔ **Enable/Disable Option:** Allows users to toggle automatic meta tag injection  
✔ **Easy-to-Use Interface:** Works inside post/page editor  
...
== Donate ==  
Support future development of this plugin by donating at:  
**[Donate Here](https://paypal.me/anupammondal)** 

== Changelog ==  
= 1.2.0 =  
– **Added Enable/Disable meta tag injection setting**  
– **Auto-fetch featured image from post thumbnail**  
– **Inject Schema Markup (JSON-LD) for enhanced SEO**  
– **Admin settings panel for global metadata defaults**  

= 1.1.0 =  
– **Added Open Graph & Twitter Card editing in post/page meta box**  
– **Implemented automatic meta description fetching**  
